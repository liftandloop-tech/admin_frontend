...
/**
 * LicenseManagementSidebar Component
 * 
 * Sidebar navigation component for License Management page.
 * Shows Licence Management as active.
 * 
 * Features:
 * - Licence Management highlighted as active
 * - Navigation links to other sections
 * - Profile section and logout button
 */
const LicenseManagementSidebar = () => {
