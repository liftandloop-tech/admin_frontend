 ...
 * Sidebar Component
 *
 * This component renders the left navigation sidebar with:
 * - QuickXPos branding header
 * - Navigation menu items (Dashboard, User Management, etc.)
 * - User profile section with avatar and email
 * - Logout button
 *
 * Features:
 * - Active route highlighting (Dashboard is currently active)
 * - User Management dropdown toggle functionality
 * - Navigation using React Router Link components
 * - Responsive design with proper spacing
 *
 * To add new navigation items:
 * 1. Add a new Link component inside the nav section
 * 2. Set the 'to' prop to the desired route path
 * 3. Add appropriate icon and text
 * 4. Use useLocation hook to highlight active route if needed
 */
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-white h-screen flex flex-col shadow-sm">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        ...
        <nav className="px-4">
          {/* Dashboard - Active route with Link navigation */}
          <div className="mb-1">
            <Link to="/dashboard">
              <div
          ...
          {/* User Management - with dropdown toggle */}
          <PermissionGate
            anyPermission={[
          ...
          {/* Reseller Management - Only for super_admin */}
          <PermissionGate permission={PERMISSIONS.RESELLER_MANAGE}>
            <div className="mb-1">
              <Link to="/reseller-management">
                <div
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-colors ${
                    isActive("/reseller-management")
                      ? "bg-gray-100"
                      : "hover:bg-gray-50"
                  }`}
                >
          ...
          {/* Profile - Ready for route implementation */}
          <div className="mb-1">
            <Link to="/profile">
              <div
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-colors ${
