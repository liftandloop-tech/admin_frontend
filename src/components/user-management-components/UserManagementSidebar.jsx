...
/**
 * UserManagementSidebar Component
 * 
 * Sidebar navigation component for User Management page.
 * Shows User Management as active with "Manage User" sub-item.
 * 
 * Features:
 * - User Management highlighted as active
 * - Dropdown showing "Manage User" sub-item
...
const UserManagementSidebar = () => {
  ...
  const [isUserManagementOpen, setIsUserManagementOpen] = useState(true); // Open by default on this page
  ...
  const isUserManagementSectionActive =
    location.pathname === '/user-management' || location.pathname === '/manage-user';
    ...
    <div className="w-64 bg-white h-screen flex flex-col shadow-sm">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        ...
        <nav className="px-4">
          ...
          {/* User Management - Active with dropdown */}
          <div className="mb-1">
            <div
              className={`flex items-center justify-between px-3 py-2.5 rounded-lg transition-colors ${
                isUserManagementSectionActive ? 'bg-gray-100' : 'hover:bg-gray-50'
              }`}
            >
              ...
              >
                <svg
                  className={`w-4 h-4 transition-transform ${isUserManagementOpen ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <Link to="/manage-user">
                  <div
                    className={`px-3 py-2 rounded-lg cursor-pointer transition-colors ${
                      isActive('/manage-user') ? 'bg-gray-100' : 'hover:bg-gray-50'
                    }`}
                  >
